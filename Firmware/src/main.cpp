...
void setup() 
  {
    ...
    pinMode (butFun1, INPUT_PULLUP);
    pinMode (butFun2, INPUT_PULLUP);
    pinMode (butFun3, INPUT_PULLUP);      
    ...
    do
      {
        display.clearDisplay();
        display.drawBitmap(0, -3, faq, 12*i, 6*i, 1);
        display.display();
        i++;
      }
    while(i != 20);  
...
//////////////////////////////////////////////////////////////////////////// REAR BUTTON ///////////////////////////////
    ...
    if ((digitalRead(butFun1) == LOW) && (butFunBef == LOW)) 
      { 
        butFunBef = 1;
        timeoff = LOW;
    ...
    else if (digitalRead(butFun1) && (butFunBef))
      {
        butFunBef = 0;
        tim2 = millis() - h2;
        if (tim2 > 50)
    ...
    if ((digitalRead(butFun2) == LOW) && (butFunBef == LOW)) 
      { 
        butFunBef = 1;
        timeoff = LOW;
        if (EEPROM.read(23) <= 35) 
          {
            Keyboard.press(arButt [EEPROM.read(23)]);
          }
        if (EEPROM.read(23) >= 36) 
          {
            epr = 23;
            selButt(&epr);
          }
      }
    else if (digitalRead(butFun2) && (butFunBef))
      {
        butFunBef = 0;
        tim2 = millis() - h2;
        if (tim2 > 50)
    ...
    if ((digitalRead(butFun3) == LOW) && (butFunBef == LOW)) 
      { 
        butFunBef = 1;
        timeoff = LOW;
        if (EEPROM.read(27) <= 35) 
          {
            Keyboard.press(arButt [EEPROM.read(27)]);
          }
        if (EEPROM.read(27) >= 36) 
          {
            epr = 27;
            selButt(&epr);
          }
      }
    else if (digitalRead(butFun3) && (butFunBef))
      {
        butFunBef = 0;
        tim2 = millis() - h2;
        if (tim2 > 50)
  ...
  //////////////////////////////////////////////////////////////////////////// CENTRAL BUTTON ///////////////////////////////
    ...
    if ((digitalRead(joyButt) == 0) && (encBefClick == 0)) 
      { 
        encBefClick = 1;
        timeoff = LOW;
    ...
    else if (digitalRead(joyButt) && (encBefClick))
      {
        encBefClick = 0;
        tim2 = millis() - h2;
        if (tim2 > 50)
  ...
  //////////////////////////////////////////////////////////////////////// Menu Entry /////////////////////////////////////
    ...
    if((digitalRead(joyButt) == LOW) && (digitalRead(butFun1)== LOW))
      {
        delay(500);
        Keyboard.releaseAll();
        Mouse.release(MOUSE_MIDDLE);
